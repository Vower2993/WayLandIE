...
object ContainerCreation {
    ...
    fun buildLaunchReadyData(
        ...
        return JSONObject().apply {
            ...
            put("zeroCopyBuffer", Container.DEFAULT_ZERO_COPY_BUFFER)
            put("midiSoundFont", "")
            put("lc_all", "")
            put("execArgs", "")
        }
    ...
    fun createContainer(
        ...
        return containerManager.createContainer(data, contentsManager)?.also {
            ...
            try {
                ...
                com.winlator.cmod.runtime.wine.WaylandDriverInstaller.install(context, prefixDir, it.getDisplayMode())
            } catch (e: Exception) {
