...
public class Container {
    ...
    public static final String DEFAULT_DISPLAY_MODE = "wayland"; // "x11", "wayland", or "gamescope" — Wayland is the default for zero-copy dmabuf rendering via the WayLandIE layer; "gamescope" adds the gamescope nested compositor on top of the Wayland bridge for FSR upscaling + frame pacing
